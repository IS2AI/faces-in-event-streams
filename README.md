...
Fig.1: Faces and facial landmarks detected using the model produced by the given project.
...
Fig.2: File structure of the FES dataset, with green representing an event stream and blue representing annotations: a) The preprocessed data are divided into three folders,
